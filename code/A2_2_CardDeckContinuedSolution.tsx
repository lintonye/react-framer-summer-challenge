...
function Card({
    ...
    const thumbUpAnimProgress = useTransform(
        position,
        [-200, 0, 200],
        [0, 0, 1]
    )
    ...
    return (
        ...
        >
            <Thumb
                bottom={10}
                left={10}
                animationProgress={thumbDownAnimProgress}
            />
            <Thumb
                up
                bottom={10}
...
export function CardDeckContinuedSolution() {
    const cards = [
        {
            name: "Strong Skinny",
            image:
    ...
    return (
        <div>
            ...
            >
                {cards
                    .reverse()
                    .map(({ name, image, backgroundColor }, index) => (
                        <Card
                            key={image}
                            image={image}
...
CardDeckContinuedSolution.defaultProps = {
    height: 375,
    width: 375,
}
